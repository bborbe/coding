...
```json
{
  ...
  "payload": {
    "query": "Documentation context needed: recent code changes scope, exported items without docs, package structure, coding guidelines location (docs/go-doc-best-practices.md), and domain-specific terminology."
  }
}
```
...
- Follow `docs/go-doc-best-practices.md`
