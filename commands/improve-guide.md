...
```bash
/improve-guide go-testing-guide.md
/improve-guide docs/go-factory-pattern.md
/improve-guide ./docs/architecture-patterns.md
```
...
Use the Task tool to invoke the `guide-improvement-assistant` agent.

Task tool with:
- subagent_type: `guide-improvement-assistant`
...
- **Review after**: Run `/doc-review` to verify quality
