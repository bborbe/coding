#!/usr/bin/env bash
#
# Verifies the four version strings of coding are aligned. Exits non-zero
...
#
# coding is plugin-only (no Go/Python binary); the four fields above are
# the entire alignment surface.
#
# This is the install-time gate, NOT the precommit gate. Drift during
# development is fine; alignment is enforced at install / release time.
#
